...
- {{MILESTONE_1_NON_GOAL}}

### Decisions and assumptions

- {{MILESTONE_1_DECISION}}
...
| --- | --- | --- | --- |
| {{DECISION_DATE}} | {{DECISION}} | {{DECISION_REASON}} | {{DECISION_OWNER}} |
